...
<table class="papa">
      <thead style="gap: 50px;" >
        ...
        $query = "SELECT * FROM apprenant WHERE id LIKE '%$terme' OR nom LIKE '%$terme%' OR prenom LIKE '%$terme%' OR date_de_naissance LIKE '%$terme%' OR formation LIKE '%$terme%' OR ville LIKE '%$terme%'";
